...
return selectSchool(_that);case _LoadDefaultZscore() when loadDefaultZScore != null:
return loadDefaultZScore(_that);case _:
  return orElse();
...
return selectSchool(_that);case _LoadDefaultZscore():
return loadDefaultZScore(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _LoadStudent value)?  loadStudent,TResult? Function( _LoadProfile value)?  loadProfile,TResult? Function( _Logout value)?  logout,TResult? Function( _SelectStudent value)?  selectStudent,TResult? Function( _ShowAlert value)?  showAlert,TResult? Function( _SetProfile value)?  setProfile,TResult? Function( _LoadSchool value)?  loadSchool,TResult? Function( _SelectSchool value)?  selectSchool,TResult? Function( _LoadDefaultZscore value)?  loadDefaultZScore,}){
final _that = this;
switch (_that) {
case _LoadStudent() when loadStudent != null:
return loadStudent(_that);case _LoadProfile() when loadProfile != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadStudent,TResult Function( void Function(Profile? profile)? callback)?  loadProfile,TResult Function( bool redirect)?  logout,TResult Function( Student student)?  selectStudent,TResult Function( String message)?  showAlert,TResult Function( Profile profile)?  setProfile,TResult Function()?  loadSchool,TResult Function( School school)?  selectSchool,TResult Function()?  loadDefaultZScore,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadStudent() when loadStudent != null:
...
return selectSchool(_that.school);case _LoadDefaultZscore() when loadDefaultZScore != null:
return loadDefaultZScore();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadStudent,required TResult Function( void Function(Profile? profile)? callback)  loadProfile,required TResult Function( bool redirect)  logout,required TResult Function( Student student)  selectStudent,required TResult Function( String message)  showAlert,required TResult Function( Profile profile)  setProfile,required TResult Function()  loadSchool,required TResult Function( School school)  selectSchool,required TResult Function()  loadDefaultZScore,}) {final _that = this;
switch (_that) {
case _LoadStudent():
...
return selectSchool(_that.school);case _LoadDefaultZscore():
return loadDefaultZScore();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loadStudent,TResult? Function( void Function(Profile? profile)? callback)?  loadProfile,TResult? Function( bool redirect)?  logout,TResult? Function( Student student)?  selectStudent,TResult? Function( String message)?  showAlert,TResult? Function( Profile profile)?  setProfile,TResult? Function()?  loadSchool,TResult? Function( School school)?  selectSchool,TResult? Function()?  loadDefaultZScore,}) {final _that = this;
switch (_that) {
case _LoadStudent() when loadStudent != null:
return loadStudent();case _LoadProfile() when loadProfile != null:
return loadProfile(_that.callback);case _Logout() when logout != null:
...
class _LoadDefaultZscore implements AppEvent {
  const _LoadDefaultZscore();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadDefaultZscore);
}
...
@override
String toString() {
  return 'AppEvent.loadDefaultZScore()';
}
...
// default z scores
@override@JsonKey() List<ZScore> get defaultZScores {
  if (_defaultZScores is EqualUnmodifiableListView) return _defaultZScores;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_defaultZScores);
}
